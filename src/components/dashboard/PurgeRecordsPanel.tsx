...
export const PurgeRecordsPanel = () => {
  ...
  const preview = useMemo(() => {
    ...
    const counts: Record<string, number> = {
      ...
      production: production.filter((r) => pendingScope === 'production_engineer' || owns(r.engineerId) || owns(r.operatorId)).length,
      ...
      outerBuyings: outerBuyings.filter((r) => pendingScope === 'production_engineer' || owns(r.engineerId)).length,
      rollBuyings: rollBuyings.filter((r) => pendingScope === 'production_engineer' || owns(r.engineerId)).length,
            ...
            >
              ...
              <div className="flex flex-col-reverse gap-2 border-t border-slate-200 p-5 sm:flex-row sm:justify-end dark:border-slate-700">
                ...
                <button
                  ...
                  disabled={busy || (preview?.total ?? 0) === 0}
